        ...
        <td style="padding: 0px 56px 0">
            ...
            >
                <p
                    ...
                    text-align: justify;"
                >
                    <strong style="margin-right: 12px;">Branch </strong> : {{ $branch_name }}
                    <br>
                </p>
            </div>
        </td>
        ...
        <td style="padding: 0px 56px 0">
            <table style="border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto; background-color: #f1f1f1;">
                <tr>
                    ...
                    <th style="padding: 10px; text-align: left; background-color: #e0e0e0; border: 1px solid #ccc;">Expired Date</th>
                </tr>
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left; background-color: white; border: 1px solid #ccc;">{{ $product->expiredDate }}</td>
                    </tr>
                @endforeach
            </table>
        </td>
